...
class HomePageView(views.View):
	...
	def get(self, request: HttpRequest) -> HttpResponse:
		return render(
			request=request, template_name='informations/homepage.html'
		)
...
class FAQView(views.View):
	...
	def get(self, request: HttpRequest) -> HttpResponse:
		return render(request=request, template_name='informations/faq.html')
...
class ProfileView(LoginRequiredMixin, views.View):
	...
	def get(self, request: HttpRequest) -> HttpResponse:
		return render(
			request=request, template_name='informations/profile.html'
		)
